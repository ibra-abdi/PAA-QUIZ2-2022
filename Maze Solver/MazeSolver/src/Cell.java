...
public class Cell{
	...
	//create walls for maze. each "true" value corresponds to left, right, up, and down
	...
	Cell(int row,int col,int cellSize){
		...
		parent = null;
		fontWeight = (int)(10+0.3*(cellSize-20)); //adjust font size according to cell size
		strokeSize = (int)((5.0/9 * ((cellSize/10)-1) )+1); // adjust stroke size according to cell size
	}
